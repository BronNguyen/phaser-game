...
export default class Battle extends Phaser.Scene {
    ...
    create() {
        ...
        const player1 = new Player(this, 100, 100, PlayerColors[TeamKeys.Red])
        const player2 = new Player(this, 200, 100, PlayerColors[TeamKeys.Green])
        const player3 = new Player(this, 300, 100, PlayerColors[TeamKeys.Blue])
        const player4 = new Player(this, 400, 100, PlayerColors[TeamKeys.Yellow])
        ...
        territories.map((_, index)=>{
            // if(index &&!(index % 13))
            const territory =  new Territory(this, index, PlayerColors[TeamKeys.Red], 0, 0, 30)
